...
public class StatisticsProvider extends ContentProvider {
    ...
    private static final String T_STATS = "Statistics";
    ...
    private static final String SQL_DB_CREATE = 
            ...
            T_NOTES_UPDATED + "," +
            " UNIQUE (" + T_NOTES_TEXT +"));";
    private static final String SQL_DB_DROP = "DROP TABLE IF EXISTS " + T_STATS;
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        switch (uriMatcher.match(uri)) {
            case MATCH_ALLNOTES :
                queryBuilder.setTables(T_STATS);
                break;
            case MATCH_NOTE :
                queryBuilder.setTables(T_STATS);
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        long id = db.insert(T_STATS, null, values);
    ...
    public int update(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        int updateCount = db.update(T_STATS, values, selection, selectionArgs);
        getContext().getContentResolver().notifyChange(uri, null);
        return updateCount;
    }
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        int deleteCount = db.delete(T_STATS, selection, selectionArgs);
        getContext().getContentResolver().notifyChange(uri, null);
        return deleteCount;
    }
}
